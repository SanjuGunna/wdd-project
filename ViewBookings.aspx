 ...
 <asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
     ...
     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" AllowPaging="True">
         ...
         <Columns>
             ...
             <asp:BoundField DataField="carid" HeaderText="Equipment Id" SortExpression="carid" >
             <HeaderStyle HorizontalAlign="Center" />
             <ItemStyle HorizontalAlign="Center" />
             </asp:BoundField>
             ...
             <asp:BoundField Visible="false" DataField="time" HeaderText="Time" SortExpression="time" >
             <HeaderStyle HorizontalAlign="Center" />
             <ItemStyle HorizontalAlign="Center" />
             </asp:BoundField>
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=dcm.uhcl.edu; Initial Catalog=c563316sp01g4;Persist Security Info=True; uid=c563316sp01g4; pwd=4686686;" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [Bookings]"></asp:SqlDataSource>
